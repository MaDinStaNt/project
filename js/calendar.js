...
Calendar.prototype.hideShowCovered = function () {
	...
	Calendar.continuation_for_the_khtml_browser = function() {
		...
		{
			if (self.hidden)
				self._closeHider(self.hider);
			else
			{
				var el = self.element;
				var p = Calendar.getAbsolutePos(el);
				var EX1 = p.x;
				var EX2 = el.offsetWidth;
				var EY1 = p.y;
				var EY2 = el.offsetHeight;
				self._setupHider(self.hider, EX1, EY1, EX2, EY2);
			}
		}
...
Calendar.prototype._setupHider = function (f, x, y, w, h)
{
	if (f)
	{
		var s=f.style;
...
Calendar.prototype._closeHider = function (f)
{
	if (f)
