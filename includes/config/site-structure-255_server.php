...
array(
	'title' => 'LLA', 'short-title' => 'LLA', 'mode' => 'hidden',  'tag' => '', 'class' => 'admin/IndexPage.php', 'template' => 'admin/index.tpl', 'children' => array(
		...
		1 => array(
			'title' => 'Пользователи', 'tag' => 'users', 'class' => 'admin/users/UsersPage.php', 'template' => 'admin/users/users.tpl', 'children' => array(
                0 => array(
                        'title' => 'User edit', 'tag' => 'user_edit', 'mode' => 'hidden', 'class' => 'admin/users/UserEditPage.php', 'template' => 'admin/users/user_edit.tpl'
                ),
				/*1 => array(
					'title' => 'Роли пользователей', 'tag' => 'roles', 'class' => 'admin/users/RolesPage.php', 'template' => 'admin/users/roles.tpl', 'children' => array(
		                0 => array(
				...
				2 => array(
					'title' => 'Группы пользователей', 'tag' => 'groups', 'class' => 'admin/users/GroupsPage.php', 'template' => 'admin/users/groups.tpl', 'children' => array(
		                0 => array(
		...
		2 => array(
			'title' => 'Локалайзер', 'tag' => 'localizer_strings', 'class' => 'admin/localizer/StringsPage.php', 'template' => 'admin/localizer/strings.tpl', 'children' => array(
                0 => array(
                    'title' => 'Редактирование строки локалайзера', 'tag' => 'loc_strings_edit', 'mode' => 'hidden', 'class' => 'admin/localizer/StringEditPage.php', 'template' => 'admin/localizer/string_edit.tpl', 'children' => array(
                	),
            	),
				1 => array(
					'title' => 'Языки', 'tag' => 'languages', 'class' => 'admin/localizer/LanguagesPage.php', 'template' => 'admin/localizer/languages.tpl', 'children' => array(
		                0 => array(
		                        'title' => 'Редактирование языка', 'tag' => 'loc_lang_edit', 'mode' => 'hidden', 'class' => 'admin/localizer/LanguageEditPage.php', 'template' => 'admin/localizer/language_edit.tpl'
		            	),
					),
				),
			),
