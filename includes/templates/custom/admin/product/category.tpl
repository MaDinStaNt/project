...
<div class="buttons_top">
	<%if product_category_show_remove%>
...
<tr>
	<td class="navi_subbgr">
		<%it:dbnavigator.objects title="<%IT:Localizer string="product_categories" /%>" enumerated="no" checkable="yes" clicklink="<%=clickLink%>id=" popuped="no" /%>
	</td>
</tr>
</table>
