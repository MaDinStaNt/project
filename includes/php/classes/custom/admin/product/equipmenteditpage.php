...
class CEquipmentEditPage extends CMasterEditPage
{
    /**
     * The table name.
     *
     * @var array
     */
    protected $_table = 'product_equipment';
    ...
    function CEquipmentEditPage(&$app, $template)
	{
		$this->IsSecure = true;
	...
	function on_product_equipment_submit($action){
