...
$RootPath = '/projtest/laserliner/'; // root path for http pages
...
//-------------------------------------------------------------------------------------------------------------------
$AdministratorEmail = 'info@laserliner.com.ua';
$AdministratorName = 'Laserliner';
//-------------------------------------------------------------------------------------------------------------------
...
define('DB_USER', 'u1544379_default'); // db user name
define('DB_PASSWORD', 'xVTQTsf3'); // db password
define('DB_DATABASE', 'u1544379_default'); // database name, will be created automatically
...
define('FUNCTION_PATH', $FilePath . 'includes/php/');
