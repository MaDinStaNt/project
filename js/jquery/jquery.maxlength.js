...
(function($) 
{
	...
	$.fn.maxlength = function(options)
	{
		var settings = jQuery.extend(
		{
			...
			statusId:		    "message_counter", // The class on the status div
			statusText:			    "", // The status text
			statusBeginText:		"", // The status text
...
//dewdewd
		return this.each(function() 
		{
			...
			if(!settings.status) 
			{
				var removeThisDiv = item.next("span");
			...
			function updateStatus()
			{
				...
				$("#" + settings.statusId).html(charactersLeft);
			};
