...
<head>
<title>OneContentPlace :: Ticket System</title>
...
<script type="text/javascript" language="javascript" src="<%=JS%>jquery/admin.ui/js/jquery-ui-1.7.2.custom.min.js"></script>
<link rel="stylesheet" href="<%=JS%>jquery/admin.ui/css/custom-theme/jquery-ui-1.7.2.custom.css" type="text/css" />
...
<p>Sorry! Page not found or you have no access rights to view this page.</p>
<p><a href="<%=HTTP%>tickets/">Go to Index page</a></p>
</td>
</tr>
</table>
</td>
...
<table cellpadding="0" cellspacing="0" class="maxw">
<tr>
<td class="footer_area" nowrap="true">&copy; 2008-2010 <strong>OneContentPlace Ticket System</strong></td>
</tr>
</table>
